...
pub fn rgba_to_yuv420(
    ...
    webp_sharpyuv::convert_rgba_to_yuv420(
        width,
        height,
        rgba,
        webp_sharpyuv::SharpYuvPlanes {
            y_stride,
            uv_stride,
            y: &mut y,
            u: &mut u,
    ...
    .map_err(|error| match error {
        webp_sharpyuv::SharpYuvError::InvalidDimensions => Vp8EncodeError::InvalidDimensions,
        webp_sharpyuv::SharpYuvError::InvalidPlaneLayout => Vp8EncodeError::InvalidPlaneLayout,
        webp_sharpyuv::SharpYuvError::AllocationFailed => Vp8EncodeError::AllocationFailed,
    })?;
    Ok(Vp8SourceYuv {
        width,
        height,

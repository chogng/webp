...
//!
//! [`decode`] owns recovery of a stored alpha payload. `webp-encode` owns
//! construction and compression choices for a new payload. `webp-container`
//! owns the `ALPH` header fields shared by both directions.

...
impl EncodeError {
    ...
    #[doc(hidden)]
    pub const fn invalid_rgba_length() -> Self {
        Self::InvalidRgbaLength
    }
    #[doc(hidden)]
    pub const fn input_size_overflow() -> Self {
        Self::SizeOverflow
    }
    #[doc(hidden)]
    pub const fn output_size_overflow() -> Self {
        Self::SizeOverflow
    }
    #[doc(hidden)]
    ...
    #[doc(hidden)]
    pub const fn invalid_animation() -> Self {
        Self::InvalidAnimation
    }
    #[doc(hidden)]
    pub const fn invalid_quality() -> Self {
        Self::InvalidQuality
    }
    #[doc(hidden)]
    pub const fn unsupported_lossy_profile() -> Self {

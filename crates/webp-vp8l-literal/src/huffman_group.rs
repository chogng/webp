...
pub(super) struct HuffmanCodes {
    pub(super) green: FastHuffmanTable,
    pub(super) red: FastHuffmanTable,
    pub(super) blue: FastHuffmanTable,
    pub(super) alpha: FastHuffmanTable,
    pub(super) distance: FastHuffmanTable,
}

/// The maximum number of prefix tables in one VP8L meta-prefix group.
pub(super) const HUFFMAN_TABLES_PER_GROUP: usize = 5;
...
pub(super) const MAX_HUFFMAN_CODE_STORAGE_BYTES: usize = 64;

pub(super) fn read_huffman_codes(
...
pub(super) fn decode_fast_symbol(
...
/// per-symbol decoder.
#[inline]
pub(super) fn decode_green_or_literal(
    codes: &HuffmanCodes,
    bits: &mut webp_core::ShiftedBitReader<'_, '_>,
    budget: &mut WorkBudget,

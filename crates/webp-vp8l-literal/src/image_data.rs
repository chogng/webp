use crate::allocation::check_allocation_budget;
use crate::allocation::checked_transform_bytes;
use crate::allocation::color_cache_size;
use crate::allocation::pixel_count;
#[cfg(test)]
use crate::decode_profile::record_entropy_path;
use crate::huffman_group::CHANNEL_ALPHABET_SIZE;
use crate::huffman_group::DISTANCE_ALPHABET_SIZE;
use crate::huffman_group::GREEN_ALPHABET_SIZE;
use crate::huffman_group::GreenOrLiteral;
use crate::huffman_group::HUFFMAN_TABLES_PER_GROUP;
use crate::huffman_group::HuffmanCodes;
use crate::huffman_group::MAX_HUFFMAN_CODE_STORAGE_BYTES;
use crate::huffman_group::decode_fast_symbol;
use crate::huffman_group::decode_green_or_literal;
use crate::huffman_group::read_huffman_codes;
use crate::pixel::pack_argb;
use crate::pixel_output::PixelOutput;
...
use webp_vp8l_entropy::decode_distance_shifted;
use webp_vp8l_entropy::decode_length_shifted;
use webp_vp8l_entropy::distance_code_to_distance;
use webp_vp8l_huffman::FastHuffmanTable;
use webp_vp8l_huffman::MAX_SECONDARY_TABLE_STORAGE_BYTES;
use webp_vp8l_huffman::ROOT_TABLE_STORAGE_BYTES;
...
pub(super) fn decode_image_data(
...
pub(super) fn prefix_image_dimensions(
    width: u32,
    height: u32,
    prefix_bits: u8,
